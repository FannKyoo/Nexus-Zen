"""
Django settings for fannweb project.
...
SECRET_KEY = 'django-insecure-9lz%)na^9u7yazas&^#deivek5k$-1qn4z9p^9j$x&!6smuw*$'
...
WSGI_APPLICATION = 'fannweb.wsgi.application'
